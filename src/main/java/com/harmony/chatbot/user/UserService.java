...
public class UserService implements UserDetailsService {
    ...
    public UserService(UserRepository userRepository, @Lazy ChatbotThemeService themeService) {
    ...
    /**
     * Returns the first ADMIN user — used to serve the public-facing theme
     * to anonymous visitors on index.html.
     */
